...
```{r}
chart(sleep, facebook_and_messenger_time ~bed_time %col=% age_rec) + geom_point()
```


```{r}
chart(sleep, video_game_time ~bed_time %col=% age_rec) + geom_point()
```

```{r}

chart(sleep,other_social_network_time~bed_time %col=% age_rec) + geom_point()
```
